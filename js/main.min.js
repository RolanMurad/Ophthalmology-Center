...
//!List Item
n.forEach((function(e){e.addEventListener("click",(function(e){e.stopPropagation(),
...
document.addEventListener("click",(function(e){e.target!==t&&(i.classList.remove("dropdown__list--visible"),o.classList.remove("dropdown__arrow--open"))})),
//!Closing Dropdown by buttons
document.addEventListener("keydown",(function(e){"Tab"!==e.key&&"Escape"!==e.key||i.classList.remove("dropdown__list--visible")}))})),
//!About us Slider
$(".about__slider").slick({
//!Main settings
arrows:!0,autoplay:!0,infinite:!0,slidesToShow:1,slidesToScroll:1,fade:!0,prevArrow:"<img src='images/slider-left.svg' class='arrow-left' alt='arrow'>",nextArrow:"<img src='images/slider-rigth.svg' class='arrow-right' alt='arrow'>"}),$(".about__slider").on("afterChange",(function(e,t,i){$("#cp").text(i+1)})),
//!Discounts Slider
$(".discounts__slider").slick({
//!Main settings
arrows:!0,autoplay:!0,infinite:!0,slidesToShow:2,slidesToScroll:1,infinite:!0,prevArrow:"<img src='images/discounts-arrow-left.svg' class='discounts__slider-left' alt='arrow'>",nextArrow:"<img src='images/discounts-arrow-right.svg' class='discounts__slider-right' alt='arrow'>",responsive:[{breakpoint:1e3,settings:{slidesToShow:2,slidesToScroll:2,dots:!0}},{breakpoint:700,settings:{slidesToShow:1,slidesToScroll:1,dots:!0}}]}),
//!Reviews slider
$(".reviews-box__slider").slick({
//!Main settings
arrows:!0,autoplay:!0,infinite:!0,slidesToShow:3,slidesToScroll:1,infinite:!0,prevArrow:"<img src='images/discounts-arrow-left.svg' class='discounts__slider-left' alt='arrow'>",nextArrow:"<img src='images/discounts-arrow-right.svg' class='discounts__slider-right' alt='arrow'>",responsive:[{breakpoint:1280,settings:{slidesToShow:2,slidesToScroll:2,dots:!0}},{breakpoint:860,settings:{slidesToShow:1,slidesToScroll:1,dots:!0}}]});document.querySelectorAll("[data-accordion]").forEach((function(e){e.addEventListener("click",(function(){
//!Vars for screen reader
const e=this.querySelector("[data-control]"),t=this.querySelector("[data-content]");
//!Open/Close
...
//!Main settings
arrows:!0,autoplay:!0,infinite:!0,slidesToShow:3,slidesToScroll:1,infinite:!0,prevArrow:"<img src='images/discounts-arrow-left.svg' class='discounts__slider-left' alt='arrow'>",nextArrow:"<img src='images/discounts-arrow-right.svg' class='discounts__slider-right' alt='arrow'>",responsive:[{breakpoint:1250,settings:{slidesToShow:2,slidesToScroll:2,dots:!0}},{breakpoint:860,settings:{slidesToShow:1,slidesToScroll:1,dots:!0}}]});const r=document?.querySelectorAll(".consultation__accordion"),a=document?.querySelectorAll(".consultation__accordion-content");r?.forEach((function(e){e.addEventListener("click",(function(){this.classList.toggle("open")}))})),a?.forEach((function(e){e.addEventListener("click",(function(e){e.stopPropagation()}))})),scrollToTopBtn=document?.querySelector(".scrolltotop"),i.addEventListener("scroll",(function(){i.scrollTop>5500?scrollToTopBtn?.classList.add("active"):i.scrollTop<3e3&&scrollToTopBtn?.classList.remove("active")})),scrollToTopBtn?.addEventListener("click",(function(){i.scrollTo(0,0)}));
//!Scroll off/on
const l={scrollPosition:0,disabledScroll(){
//!For Windows scroll ban
l.scrollPosition=window.scrollY,document.body.style.cssText=`\n   overflow : hidden;\n   //!Scroll ban for Safari\n   position: fixed;\n   top : -${l.scrollPosition}px;\n   left: 0;\n   height: 100vh;\n   width: 100vw;\n   padding-right: ${window.innerWidth-document.body.offsetWidth}px;\n   `},enabledScroll(){document.body.style.cssText="",window.scroll({top:l.scrollPosition})}};document.querySelectorAll(".modal__wrapper").forEach((function(e){
//!Vars
const t=e.querySelector("[data-modal-button]"),i=e.querySelector("[data-modal]"),n=e.querySelector("[data-modal-close]"),o=e.querySelector(".modal-window"),s=e.querySelector(".consultation__button");t.addEventListener("click",(function(){i.classList.remove("hidden"),l.disabledScroll()})),n.addEventListener("click",(function(){i.classList.add("hidden"),l.enabledScroll()})),s.addEventListener("click",(function(){i.classList.add("hidden"),l.enabledScroll()})),i.addEventListener("click",(function(){this.classList.add("hidden"),l.enabledScroll()})),o.addEventListener("click",(function(e){e.stopPropagation()}))}))}));